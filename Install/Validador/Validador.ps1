# Shopping Validador Livro eletronico
# AUTOR  : Ivo Dias 
# VERSAO : 02.08.18.MSC 
...
$nome = "Validador"
$fullname = "Validador Livro eletronico"
$versao = "12.2.1"
$logPath = "$Installpath\LOG\$hostname.$nome.log"
$fullpath = "$Installpath\Install\$nome"
$instalador = "validador.exe"
$pasta = "C:\Program Files (x86)\GDF"
$date = Get-Date
...
# Inicia a instalação
$process = psexec \\$hostname -s cmd /c C:\temp\$instalador /verysilent
