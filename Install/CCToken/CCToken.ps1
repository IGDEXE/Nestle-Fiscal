# Shopping CC Token WebComponent
# AUTOR  : Ivo Dias 
# VERSAO : 02.08.18.MSC 
...
$nome = "CCToken"
$fullname = "CC Token WebComponent"
$versao = "2018"
$logPath = "$Installpath\LOG\$hostname.$nome.log"
$fullpath = "$Installpath\Install\$nome"
$instalador = "CCTokenWebComponentSetup.msi"
$pasta = "C:\Program Files (x86)\Code Ciphers\CCTokenWebComponent\"
$date = Get-Date
